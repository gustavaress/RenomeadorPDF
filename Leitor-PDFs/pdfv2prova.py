...
def extrair_texto(caminho_arquivo):
    ...
    with open(caminho_arquivo,"rb") as arquivo:
        # Estou atribuindo o nome de leitor_pdf para essa função que le o arquivo pdf e depois dou o parametro que é o arquivo que ele deseja abrir
    ...
    if arquivo.startswith(inicioArquivo):
        ...
        try:
            ...
            if nome:
                ...
                # Renomear arquivo. Simplesmente uma função que renomeia arquivo. Essa função PRECISA do caminho completo dos arquivos de origem e destino. O primeiro nome sendo o caminho/nome antigo, e o segundo o caminho/nome novo
                os.rename(caminho_arquivo, novo_caminho_arquivo)
                # Mensagem de sucesso
                print(f"Arquivo renomeado com sucesso! {arquivo} >>> {novo_nome}")
